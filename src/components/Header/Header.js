      ...
      <div className='navbar-container'>
        ...
        <nav className='navbar-right'>
          <ul className='navbar-ul'>
            ...
            <li className='navbar-li'><NavLink className="navbar-li-text" to="/dicesfight" aria-label="DicesFight">DicesFight</NavLink></li>
            <li className='navbar-li'><NavLink className="navbar-li-text" to="/workshopstation" aria-label="DicesFight">WorkShopStation</NavLink></li>
          </ul>
        </nav >
      </div>
